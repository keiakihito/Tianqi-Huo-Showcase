...
export const projects: Project[] = [
    ...
    { // Project 1
        ...
        type: "image",
        images: [
            { src: "/images/project1/Project1 Web_Page_01.jpg", description: "" },
            ...
            { src: "/images/project1/Project1 Web_Page_07.jpg", description: "" },
            { src: "/images/project1/Project1 Web_Page_08.jpg", description: "" },
            { src: "/images/project1/Project1 Web_Page_09.jpg", description: "" },
            { src: "/images/project1/Project1 Web_Page_10.jpg", description: "" },
            { src: "/images/project1/Project1 Web_Page_11.jpg", description: "" },
            { src: "/images/project1/Project1 Web_Page_12.jpg", description: "" },
            { src: "/images/project1/Project1 Web_Page_13.jpg", description: "" },
            { src: "/images/project1/Project1 Web_Page_14.jpg", description: "" },
            { src: "/images/project1/Project1 Web_Page_15.jpg", description: "" },
            { src: "/images/project1/Project1 Web_Page_16.jpg", description: "" },
            { src: "/images/project1/Project1 Web_Page_17.jpg", description: "" },
            { src: "/images/project1/Project1 Web_Page_18.jpg", description: "" },
            { src: "/images/project1/Project1 Web_Page_19.jpg", description: "" },
        ],
